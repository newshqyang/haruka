...
public class AndroidFileUtils {
    ...
    去掉隐藏文件
     */
    public static void removeHiddenFile(List<File> fileList) {
    ...
    调用系统文件浏览器，选择文件
     */
    public static void selectFile(Activity activity, int REQUEST_CODE) {
    ...
    public static void openFile(Context context, File file){
        String mimeType = AndroidFileUtils.getMIMEType(file);
//        if (mimeType.contains("image")) {
//            context.startActivity(IntentFactory.getIntent(context, IntentFactory.TYPE_IMAGE).putExtra("imagePath", file.getAbsolutePath()));
//            return;
//        } else if (mimeType.contains("video")) {
//            context.startActivity(IntentFactory.getIntent(context, IntentFactory.TYPE_VIDEO)
//                    .putExtra("videoPath", file.getAbsolutePath()));
//            return;
//        }
//        if (mimeType.contains("video")) {
//            context.startActivity(new Intent(context, PlayActivity.class).putExtra("path", file.getAbsolutePath()));
//            return;
//        }
        ...
        if (mimeType.equals(".apk")) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                UUtils.getInstallPermission(context);
                return;
            }
